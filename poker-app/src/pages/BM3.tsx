    ...
    <>
      <Section title="Opening Into Covering Stacks (You Cover)">
        ...
        <div className="flex flex-wrap gap-4 mb-4">
          <RangePreview title="BTN 125bb · Covering 2x+ (deep BB) · ~75%" range="22+, A2s+, A2o+, K2s+, K5o+, Q2s+, Q7o+, J2s+, J7o+, T2s+, T7o+, 92s+, 97o+, 82s+, 87o, 72s+, 76o, 62s+, 65o, 52s+, 54o, 42s+, 43o, 32s" color="#5fd0a8" />
          <RangePreview title="BTN 80bb · Covering but close (73bb BB) · ~68%" range="22+, A2s+, A2o+, K2s+, K7o+, Q4s+, Q8o+, J6s+, J8o+, T6s+, T8o+, 96s+, 98o, 86s+, 87o, 75s+, 76o, 64s+, 65o, 53s+, 54o, 43s" color="#5fd0a8" />
          <RangePreview title="UTG 100bb · Covering 2x+ (45bb BB) · ~35%" range="22+, A2s+, A8o+, ATo+, K8s+, K9o+, KJo+, Q9s+, QJo+, J9s+, JTo, T9s, 98s, 87s, 76s, 65s" color="#5fd0a8" />
          <RangePreview title="UTG 58bb · Cover most, covered by one · ~25%" range="33+, A4s+, A9o+, AJo+, K9s+, KJo+, QTs+, QJo+, JTs, T9s, 98s" color="#5fd0a8" />
          <RangePreview title="UTG 65bb · Covering (26bb BB) · ~38%" range="22+, A2s+, A7o+, ATo+, K7s+, K9o+, Q8s+, QTo+, J8s+, JTo, T8s+, 98s, 87s, 76s, 65s, 54s" color="#5fd0a8" />
        </div>
