...
const quizzes: QuizQuestion[] = [{q:"SB 11bb, BB 12bb on bubble. SB strategy?",o:["Limp most, raise premiums","Shove/raise, no limps","Min-raise all, fold to jams","Limp-fold"],a:1,why:"BB overfolds ~85%. Limping gives free equity to hands that fold to a shove."},{q:"SB covered, 10bb vs 45bb. Strategy?",o:["Limp wide","No limps; tight shove/fold (~33% VPIP)","Min-raise all","Limp-shove"],a:1,why:"Below ~18bb covered, no limps. FGS: folding has value (others may bust)."},{q:"Open-shove selection when covered in ICM?",o:["Wider, weaker hands","Shift up — drop A2s/A3s, AJo threshold","Same as chip","Only premiums"],a:1,why:"Bluffs shift up with value. A2s/A3s drop; AJo becomes threshold."},{q:"SB 14bb vs BB 16bb (close). VPIP vs BB 45bb?",o:["Tighter — closer stacks risk more","Wider — game of chicken, BB can't defend wide","Same","Always fold"],a:1,why:"Losing hurts BB's equity more when close → BB defends tighter → SB wider."},{q:"40+bb covered SB — limp-shove pairs?",o:["Yes, standard","Disappears — limp-call; BB can't pile vs uncapped traps","More limp-shoves","Never limp"],a:1,why:"SB is uncapped with traps; BB can't pile. Limp-call instead."},{q:"BB fold freq vs SB cover (short) vs chip model?",o:["~37% both","~78-90% (ICM) vs ~37% (chip)","~50%","Same"],a:1,why:"ICM pressure doubles BB fold frequency vs chip model."}]

const examples: HandExample[] = [
  { tag: "Covering 2x+", tagVariant: "default", board: <>BTN 125bb · avg 50bb · BB 36/68bb</>, desc: "Covering deep blinds", verdict: "agree", verdictText: "System agrees", system: "Open ~75%, more of everything vs 53% baseline.", solver: "~75% VPIP." },
  { tag: "Covering but close", tagVariant: "risk", board: <>BTN 80bb · BB 73bb</>, desc: "Close stacks", verdict: "agree", verdictText: "System agrees", system: "Dial to ~68% — closer stacks hurt more if you lose (7bb left).", solver: "~68% VPIP." },
  { tag: "Heavy open shoves", tagVariant: "default", board: <>BTN · blinds sub-30bb · you much bigger</>, desc: "Covering short blinds", verdict: "agree", verdictText: "System agrees", system: "~75% VPIP + heavy open shoves (Kx suited, Qx suited, Jx suited).", solver: "BB calls <10%. Missing open shoves is a common leak." },
  { tag: "Covering EP 2x+", tagVariant: "default", board: <>UTG 100bb · table 20-50bb · BB 45bb</>, desc: "Covering the table from EP", verdict: "agree", verdictText: "System agrees", system: "Open ~35% (like a 30bb CO open in chips).", solver: "~35-36% VPIP." },
  { tag: "Mixed: cover rest, covered by one", tagVariant: "risk", board: <>UTG 58bb · covered by CO</>, desc: "Cover most, covered by one", verdict: "agree", verdictText: "System agrees", system: "~25-26%. Wider than baseline; J8s/Q8s/T8s near zero but +EV if CO passive.", solver: "~25-26% VPIP." },
  { tag: "Deep BB composition", tagVariant: "default", board: <>UTG 65bb · BB 26bb</>, desc: "Covering a mid BB", verdict: "agree", verdictText: "System agrees", system: "38.5%. Low suited connectors, sliver of 33s, marginal high-low suited.", solver: "~38.5% VPIP." },
]
        ...
        <DecisionMatrix
          ...
          rows={[
            { label: "Cover by 2x+ (BTN)", cells: [
              { action: "~75% VPIP", sub: "Low suited connectors, low pairs, suited high-low all OK.", color: "green" },
