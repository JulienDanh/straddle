...
const examples: HandExample[] = [
  ...
  { tag: "Covered short — fold", tagVariant: "fold", board: <>SB 10bb · BB 45bb · SB covered</>, desc: "Covered, short, direct bubble", verdict: "agree", verdictText: "System agrees", system: "No limps; tight shove/fold (~33% VPID).", solver: "Limping reappears at 25% field left, gone on direct bubble." },
  { tag: "Game of chicken", tagVariant: "risk", board: <>SB 14bb · BB 16bb</>, desc: "Close stacks", verdict: "agree", verdictText: "System agrees", system: "Wider VPID; more open-shoving than vs big stack.", solver: "BB can't defend wide — losing hurts BB's equity." },
        ...
        <DecisionMatrix
          ...
          rows={[
            { label: "Short (≤12bb)", cells: [
              ...
              { action: "Tight shove/fold", sub: "~33% VPID. No limps. Folding has value.", color: "red" },
            ]},
            { label: "Close (14-17bb)", cells: [
              { action: "High VPID", sub: "Game of chicken; more open-shoving.", color: "green" },
              { action: "Wider VPID", sub: "Game of chicken; BB can't defend wide.", color: "orange" },
            ]},
