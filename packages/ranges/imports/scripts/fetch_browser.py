...
Usage (repo root):
  python3 packages/ranges/scripts/fetch_browser.py --catalog
  python3 packages/ranges/scripts/fetch_browser.py --rfi BTN --depth 30
  python3 packages/ranges/scripts/fetch_browser.py --bb-vs UTG --depth 40
  python3 packages/ranges/scripts/fetch_browser.py --rfi UTG --board Kh8h3c --cbet
  python3 packages/ranges/scripts/fetch_browser.py --stacks 40.125-35.125-... --rfi UTG
  python3 packages/ranges/scripts/fetch_browser.py --history-spot 9 \
...
IMPORTS = pathlib.Path(__file__).resolve().parent.parent / "imports"
