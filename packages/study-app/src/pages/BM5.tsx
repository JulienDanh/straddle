  ...
  return (
    <>
      <Section title="Blinds Facing an Open on the Bubble">
        ...
        <h3>Defender stack × opener position</h3>
        <table>
          <tr><th>Defender</th><th>vs EP (UTG) open</th><th>vs BTN open</th></tr>
          <tr><td><strong>SB short (≤20bb)</strong></td><td><Action variant="fold">No cold calls; raise/fold</Action> — 3-bet value: Kings+, AQ (Queens mix).</td><td><Action variant="fold">No cold calls; raise/fold</Action> — Re-steal with Ax blockers.</td></tr>
          <tr><td><strong>SB deeper (25+bb)</strong></td><td><Action variant="call">Some cold calls begin</Action> — especially if BB is short/handcuffed.</td><td><Action variant="bet">Cold calls expand</Action> — SB "almost in the BB" when BB is short.</td></tr>
          <tr><td><strong>BB short (≤15bb)</strong></td><td><Action variant="fold">Very tight defense</Action> — some cold calls. Fold dominated offsuit.</td><td><Action variant="call">Tight; re-steal shoves</Action> — Ax blocker-heavy. Don't shy from bust risk.</td></tr>
          <tr><td><strong>BB covering opener</strong></td><td><Action variant="bet">Defend wide; cold call looser</Action> — fold dominated offsuit. King-X offsuit ~0.</td><td><Action variant="bet">Defend wide; re-steal aggressively</Action> — can donk-lead low/mid boards post.</td></tr>
        </table>
      ...
      <StrategyQuestions
        title="BM5 — Blinds vs Open Rules"
        questions={[
