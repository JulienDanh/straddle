...
export function S11Page() {
  return (
    <Section title="System 11 — Hero Calling">
      ...
      <Leak items={[
      ['Treating all bluff catchers as equal', 'some are worth 27% of the pot, others are worth zero'],
      ...
      <Subhead>Good vs bad bluff catchers</Subhead>
      ...
      <Subhead>Core principle</Subhead>
