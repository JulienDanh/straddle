...
export function BM3Page() {
  return (
    <Section title="Open vs Smaller Stacks — You Cover Them">
      <p className="mb-1"><strong className="text-good">Covering = you can bust them.</strong> You have the stacks behind covered — you can lose the pot and keep playing; they can't.</p>
      ...
      <Leak items={[
        ['Opening too wide on the BTN on short stacks when other shorties are present', 'FGS: folding has positive $EV when others may bust first — the thinnest hands pass'],
      ]} />
...
<p className="mt-6 mb-1 text-sm text-muted">Solved covering opens — UTG at 50bb covering 12&ndash;24bb stacks (BB 4bb) opens ~28%, and at 100bb covering the table ~32%, roughly double the equal-stack bubble baseline. These nodes also carry a half-stack raise option; the panels show the primary 2bb open:</p>
              ...
              <Subhead>Composition by BB depth (when you cover)</Subhead>
