import { Section, Callout, Leak, Code, Action, DataTable, Subhead } from '@poker/design-system/src/components/ui'
...
export function BMPrimerPage() {
  return (
    <Section title="Bubble Mastery — ICM & FGS Foundations">
      ...
      <Leak items={[
      ['Open shoving 15bb on the bubble with a shorter stack present', 'min-raising is 4–5x better in tournament equity — open shoving AJo loses ~$17.70, JTs loses ~$35'],
      ]} />
      ...
      <>
              ...
              <Subhead>The three models</Subhead>
              ...
              <Subhead>Stack situation × model</Subhead>
              ...
              <Subhead>Sizing / Numbers</Subhead>
              ...
              <Subhead>Field-Size Impact</Subhead>
