  ...
  return (
    <>
      <Section title="BB Covers BTN — Postflop">
        ...
        <table>
          <tr><th>Board class</th><th>BB defense (covering)</th><th>BTN c-bet (covered)</th></tr>
          <tr><td><strong>Low / paired (5-5-4, 6-6-2)</strong></td><td><Action variant="bet">Lead near-range</Action> — Covering by ~1.5-2x+. Doesn't exist in chip-EV.</td><td><Action variant="check">Check back high freq (&gt;50%)</Action> — BB has the low cards; BTN lacks backup.</td></tr>
          <tr><td><strong>High paired (J-J-2 / A-K-K)</strong></td><td><Action variant="raise">Check-raise heavy</Action> — Minimal check-call. Near CR-or-fold.</td><td><Action variant="check">Check back ~70%</Action> — BB check-raises ~10.5% aggressively.</td></tr>
          <tr><td><strong>Ace-Broadway-Broadway (A-K-Q)</strong></td><td><Action variant="call">Defend normally</Action> — BB doesn't have the connecting hands.</td><td><Action variant="bet">Range bet / near-range</Action> — A-K-Q, A-K-J, A-K-T, A-Q-T, A-J-T.</td></tr>
          <tr><td><strong>A-Q-2 (no OESD, no FD)</strong></td><td><Action variant="call">Check-call mostly</Action> — BTN polar overbet.</td><td><Action variant="bet">Polar ~105% overbet + check</Action> — Front-load: fold out gutters. No small bet.</td></tr>
          <tr><td><strong>Monotone</strong></td><td><Action variant="raise">Lead / check-raise</Action> — BB can have any flush.</td><td><Action variant="check">~50% check</Action> — BTN lacks flushes (shoves suited pre).</td></tr>
        </table>

        <h3>Core Rules — BB Defense (covering)</h3>
        <table>
        ...
        <h3>Core Rules — BTN C-bet (covered)</h3>
      ...
      <StrategyQuiz
        title="BM9 — BB Covers BTN: Action?"
        options={[
