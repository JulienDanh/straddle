import { Section, Callout, DataTable, Subhead } from '@poker/design-system/src/components/ui'
...
export function PrimerPage() {
  return (
    <Section title="Preflop Primer">
      ...
      <>
              <Subhead>Core idea: all RFI ranges are <em>linear</em></Subhead>
              ...
              <Subhead>RFI range perimeters</Subhead>
              ...
              <Subhead>Big Blind defense</Subhead>
